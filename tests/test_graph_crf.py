...
from pystruct.inference_methods import _inference_lp
...
def test_graph_crf_energy_lp_integral():
    ...
    inf_res, energy_lp = _inference_lp(x_1, unary_params, pairwise_params,
...
def test_graph_crf_energy_lp_relaxed():
    ...
    unary_params = crf.get_unary_weights(w)
    pairwise_params = crf.get_pairwise_weights(w)
    inf_res, energy_lp = _inference_lp(x_2, unary_params, pairwise_params,
